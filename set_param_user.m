...
function [] = set_param_user(varargin)
	...
	param_user_str.t1_t_gm_correct       = 0; % Look-locker corrected T1 relaxation of GM tissue
	param_user_str.t1_t_wm_correct       = 0; % Look-locker corrected T1 relaxation of WM tissue
	param_user_str.t1_a_correct          = 0; % Look-locker corrected T1 relaxation of arterial blood
