...
function [] = set_param_basis()
	...
	param_mr_str.flip_angle  = 2 * pi / 360 * 30; % flip angle of 30 degrees of Look locker readout (ETP)
	param_mr_str.phi         = 2 * pi / 360 * 45; % angle (45 degrees) blood flow suppression used in polar coordinate, exact value not matters (MACQ)
	param_mr_str.theta       = 2 * pi / 360 * 45; % angle (45 degrees) blood flow suppression used in polar coordinate, exact value not matters (MACQ)
